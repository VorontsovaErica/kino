...
<head>
    <body style="margin-top: 2%;background-color:#27263D">
        <div class="container" style="display: block; text-align: center;background-color: #4f4d7a; border-radius:5%; height: 550px; width:80%">
            ...
            <form action="controller/CreateNews.php" method="GET" class="form-inline">
            <div class="form-group" style = "color: #c2bfcf;font-size: 18px">
                <label for="exampleInputEmail1" placeholder="Введите название новости">Название</label>
                <input class="form-control" type="text" name="header" required>
            </div>
            <div class="form-group" style = "color: #c2bfcf;font-size: 18px">
                <label for="exampleInputEmail1" placeholder="Введите содержание">Текст новости</label>
                <textarea class="form-control" name="text" cols="20" rows="10"></textarea>
            </div>
            <div class="form-group" style = "color: #c2bfcf;font-size: 18px">
                <label for="exampleInputEmail1" placeholder="обложка новости">Обложка</label>
                <input class="form-control" type="text" name="photos" required>
            </div>
            <br>
